...
For example (takes a few seconds to load):
...
The browser within the RStudio IDE does not support the use of iframes that point to external URLs. You are encouraged to open such documents in a different browser, such as Chrome or Firefox. 
